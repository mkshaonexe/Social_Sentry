...
public class GraphicOverlay extends View {
    ...
    public abstract static class Graphic {
        ...
        public float translateX(float x) {
            float scaledX = scale(x) - overlay.postScaleWidthOffset;
            if (overlay.isImageFlipped) {
                return overlay.getWidth() - scaledX;
            } else {
                return scaledX;
            }
        }
    ...
    private void updateTransformationIfNeeded() {
        ...
        // Match PreviewView's CENTER_CROP behavior exactly
        ...
        // Reset and build transformation matrix
        transformationMatrix.reset();
        
        // First scale the image
        transformationMatrix.setScale(scaleFactor, scaleFactor);
        
        // Then translate to center the cropped image
        ...
        // Debug logging for transformation parameters
        Log.d("GraphicOverlay", String.format(
            "Transformation updated: imageSize=(%dx%d), viewSize=(%.0fx%.0f), " +
            "scaleFactor=%.3f, offset=(%.1f,%.1f), flipped=%s",
            imageWidth, imageHeight, viewWidth, viewHeight, 
            scaleFactor, postScaleWidthOffset, postScaleHeightOffset, isImageFlipped
        ));
    }
